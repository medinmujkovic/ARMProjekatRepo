...
# Čekanje da se oslobodi pozadinski apt lock
echo "Čekam da se oslobodi apt lock..."
while fuser /var/lib/dpkg/lock-frontend >/dev/null 2>&1 ; do
  echo "Apt lock je zauzet pozadinskim procesima, čekam 5 sekundi..."
  sleep 5
done
...
# Docker instalacija (Sada sa sigurnom 'jammy' oznakom koja se ne može pokvariti)
